        ...
        <div>
          <div className={styles.paragraphDiv}>
            ...
            <p>
              ...
              thing it craves is the process. <br />
          ...
          <div className={styles.paragraphDivRight}>
            ...
            but we have a range of event equipment as well as regular contact
            with trusted suppliers, performers, venues and technicians.
          ...
          <div className={styles.paragraphDivBottom}>
            ...
            necessary permits <br /> have experienced staff on-site who will
          ...
          <div className={styles.paragraphDivLeft}>
            ...
            <br /> A good event management company will have contingencies in
            case plan A or B doesn’t work.
          </div>
